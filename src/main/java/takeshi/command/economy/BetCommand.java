...
package takeshi.command.economy;
...
import takeshi.db.controllers.CBet;
import takeshi.db.controllers.CBetOption;
...
public class BetCommand extends AbstractCommand {
	...
	public String[] getUsage() {
		return new String[] { "bet                    //check out what bets there are and where you participate in",
	...
	public String simpleExecute(DiscordBot bot, String[] args, MessageChannel channel, User author,
		...
		/**
		 * table bets id, title, creator?, timestamp, status, price
		 */
		/**
		 * table bet_options id, bet_id, description
		 */
		/**
		 * table bet_users id, bet_option_id,
		 */
