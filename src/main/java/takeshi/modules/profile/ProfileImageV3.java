...
public class ProfileImageV3 extends ProfileImage {
	...
	public File getProfileImage() throws IOException {
		...
		BufferedImage result = new BufferedImage(320, 265, BufferedImage.TYPE_INT_ARGB);
		...
		g.drawImage(xpProgressBar, 137, 133, 317 - (int) ((181D / 100D) * (100D - xpPercent)), 148, 0, 0, 175, 15,
				null);
		...
		GfxUtil.addRightText("made by Techtor", creditFont, 318, 199, g, new Color(0x3A3A38));
		...
		// GfxUtil.addRightText("" + rng.nextInt(1000), score, 290, 118, g, new
		// Color(0x36cbe9));//currency
